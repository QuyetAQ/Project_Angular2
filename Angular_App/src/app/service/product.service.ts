...
export class ProductService{
    ...
    GetAllSearchSortPagination(keyword:string, keysort:string, modesort:string, page:number,limit:number){
        return this._http.get(this.productUrl+'/'+'?search='+keyword+'&sortBy='+keysort+'&oder='+modesort+'&page='+page+'&limit='+limit)
            .map((respone:Response) => respone.json());
    }
    GetAllSearchSort(keyword:string, keysort:string, modesort:string){
        return this._http.get(this.productUrl+'/'+'?search='+keyword+'&sortBy='+keysort+'&oder='+modesort)
            .map((respone:Response) => respone.json());
    }
}
